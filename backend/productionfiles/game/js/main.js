...
class OceanMap {
    ...
    closeMap()
    {
        if (this.mapActive)
        {
            ...
            this.scene.remove(this.lightRight, this.lightLeft, this.ambientLight);
...
class DragonMap {
    ...
    initMap()
    {
        ...
        // this.arena.paddleRight.light.color.set(0xff0000);
        // this.arena.paddleLeft.light.color.set(0xff0000);
