...
urlpatterns = [
    ...
    path('change_profile/', updateUserInfo.change_profile, name="change_profile"),
    path('change_profile/change_profile_info/', updateUserInfo.change_profile_info, name="change_profile_info"),
