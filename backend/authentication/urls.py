...
from blockchain.views import create_tournament_view, get_tournament_view, all_tournaments_view
...
urlpatterns = [
    ...
    path('get_tournament/<int:tournament_id>/', get_tournament_view, name='get_tournament'),
