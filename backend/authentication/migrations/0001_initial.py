# Generated by Django 4.2.11 on 2024-06-03 12:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('en', 'english'), ('fr', 'french'), ('es', 'espagnol')], default='en', max_length=10)),
                ('last_login_date', models.DateField(blank=True, null=True)),
                ('status', models.CharField(choices=[('online', 'online'), ('offline', 'offline'), ('in_game', 'in_game')], default='offline', max_length=10)),
                ('profile_picture', models.ImageField(default='default.png', upload_to='')),
                ('bio', models.CharField(blank=True, max_length=28, null=True)),
